...
template <typename T> inline EntryOfVLTree<T>::EntryOfVLTree( const EntryOfVLTree<T>& e ) : m_t( e.m_t ) , m_left_branch( e.m_left_branch == &e ? this : e.m_left_branch ) , m_right_branch( e.m_right_branch == &e ? this : e.m_right_branch ) , m_leftmost_node( this ) , m_rightmost_node( this ) { if( e.m_leftmost_node != &e ){ m_leftmost_node = e.m_leftmost_node; m_rightmost_node = e.m_rightmost_node; } }

template <typename T> EntryOfVLTree<T>& EntryOfVLTree<T>::operator=( const EntryOfVLTree<T>& e )
{

  m_t = e.m_t;
  m_left_branch = ( e.m_left_branch == &e ? this : e.m_left_branch );
  m_right_branch = ( e.m_right_branch == &e ? this :  e.m_right_branch );

  if( e.m_leftmost_node == &e ){

    m_leftmost_node = m_rightmost_node = this;
